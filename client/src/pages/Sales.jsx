                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-2">
                                                <div className="w-8 h-8 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center text-xs font-bold uppercase">
                                                    {sale.user?.fullName.charAt(0)}
                                                </div>
                                                <span className="text-sm font-medium text-slate-900">{sale.user?.fullName}</span>
                                            </div>
                                        </td>
                        ...
                        <div className="p-8 space-y-8">
                            <div className="flex justify-between text-sm">
                                <div>
                                    ...
                                    <p className="font-bold text-slate-900">{selectedSale.user?.fullName}</p>
                                </div>
